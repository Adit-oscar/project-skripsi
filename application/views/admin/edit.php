      ...
      <div class="col-md-5">
        <div class="card card-primary bg-gray-light">
          ...
          <form action="" method="post">
            <!-- card body -->
            <div class="card-body">
              <input type="hidden" name="id_admin" class="form-control" value="<?= $admin->id_admin ?>">
              ...
              <div class="form-group">
                ...
                <input type="text" id="password" name="password" class="form-control" value="<?= $admin->password ?>">
